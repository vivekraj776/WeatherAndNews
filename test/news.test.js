...
describe('GET /news/headlines', () => {
    it('should get the news', (done) => {
        ...
        chai.request(app)                                                     //calling localhost for server
            .get('/news/headlines')
            .query({search: search})
            .set('x-auth','eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MDcxY2VmM2U2NDg2MjMxZDliY2YyOTAiLCJhY2Nlc3MiOiJhdXRoIiwiaWF0IjoxNjE4MDcxMjgzfQ.wSEUHB3zWGtUDYBQsdsFjzG3lAwVS-ViI9l9eQVMu8o')
            .end((error, response) => {
